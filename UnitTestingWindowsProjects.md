...
Your unit testing code is not likely to be in the same namespace as your project under test. Therefore, if you see a syntax error that says "...due to its protection level....", it is because you have defined your classes without an appellation of "public" (make sure it isn’t defined as "internal"."
